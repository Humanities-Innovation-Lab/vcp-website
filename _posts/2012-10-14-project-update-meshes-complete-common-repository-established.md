...
date: 2012-10-14
source: "http://visionarycross.org/project-update-meshes-complete-common-repository-established/"
archived: "20180922171050"
...
Last week, Matteo, Marco, and their students at [ISTI](http://www.isti.cnr.it/) finished processing the main [meshes](http://en.wikipedia.org/wiki/Polygon_mesh) of the cross, minus the [textures](http://en.wikipedia.org/wiki/Texture_mapping). This means, in essence, that we have complete abstract models of the cross based on the millions of measurement points we captured during our time in Ruthwell (If you are interested in reading more about the process of 3D modelling, there is a decent [series on 3D Computer Graphics in the Wikipedia](http://en.wikipedia.org/wiki/3D_computer_graphics) that can serve as a starting point). These are representations of the pure form of the cross's surface--there is no colour information, only the positioning of these points on the cross's surface in relation to each other. I [posted some screen shots from earlier drafts of this work](http://visionarycross.org/some-early-screenshots-from-the-3d-work/) in July.
